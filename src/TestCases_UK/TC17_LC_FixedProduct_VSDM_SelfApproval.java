...
public class TC17_LC_FixedProduct_VSDM_SelfApproval {
	...
	{		
		reports=new ExtentReports("D:\\Workspace\\CPQ\\src\\Report\\TC17_LC_FixedProduct_VSDM_SelfApproval.html",true);
		logger=reports.startTest("TC17_LC_FixedProduct_VSDM_SelfApproval");
		CommonActions.LaunchDriver.launchbrowser();
		logger.log(LogStatus.PASS, "browser launch successfully");
	}
	
	@Test
	public void fixedProductVSDM() throws IOException, InterruptedException, AWTException
	{
