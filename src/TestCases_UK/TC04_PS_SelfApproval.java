...
public class TC04_PS_SelfApproval {
	...
	{		
		reports=new ExtentReports("D:\\Workspace\\CPQ\\src\\Report\\TC04_PS_SelfApproval.html",true);
		logger=reports.startTest("TC04_PS_SelfApproval");
		CommonActions.LaunchDriver.launchbrowser();
		logger.log(LogStatus.PASS, "browser launch successfully");
	}
	
	@Test
	public void publicSectorSelfApproval() throws IOException, InterruptedException, AWTException
	{
