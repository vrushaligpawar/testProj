...
public class TC09_LC_ProposalGenerate {
	...
	{		
		reports=new ExtentReports("D:\\Workspace\\CPQ\\src\\Report\\TC09_LC_ProposalGenerate.html",true);
		logger=reports.startTest("TC09_LC_ProposalGenerate");
