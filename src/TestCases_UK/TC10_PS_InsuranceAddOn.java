...
public class TC10_PS_InsuranceAddOn {
	...
	{		
		reports=new ExtentReports("D:\\Workspace\\CPQ\\src\\Report\\TC10_PS_InsuranceAddOn.html",true);
		logger=reports.startTest("TC10_PS_InsuranceAddOn");
	...
	public void InsuranceAddOn() throws IOException, InterruptedException, AWTException
	{
		...
		aimt.setUniqueID("UKTraiff1");pimt.addIntegratedMobileTraiffPS();//add integrated mobile tariff
		aimt.selectTraiffType();
		adb.setUniqueID("UKBrand1"); adb.addDevicesBrand();//add Brand devices
		adao.setUniqueID("UKAddOn1");adao.addDevicesAddOns();//add Addons devices
