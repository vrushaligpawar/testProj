...
public class TC05_PS_CMApproval {
	...
	{		
		reports=new ExtentReports("D:\\Workspace\\CPQ\\src\\Report\\TC05_PS_CMApproval.html",true);
		logger=reports.startTest("TC05_PS_CMApproval");
		CommonActions.LaunchDriver.launchbrowser();
		logger.log(LogStatus.PASS, "browser launch successfully");
	}
	
	@Test
	public void publicSectorcmApproval() throws IOException, InterruptedException, AWTException
	{
