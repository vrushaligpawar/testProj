...
public class TC20_SME_FixedProduct_ReconfigureQuote_Salesspecialist {
	...
	{		
		...
		logger=reports.startTest("TC20_SME_FixedProduct_ReconfigureQuote_Salesspecialist");
		CommonActions.LaunchDriver.launchbrowser();
		logger.log(LogStatus.PASS, "browser launch successfully");
	}
	
	@Test
	public void reconfigureQuoteSalesspecialist() throws IOException, InterruptedException, AWTException
	{
		...
		Thread.sleep(9000);
		cai.logout();
		la.setUniqueID("UK_SS");   
		la.FillLoginInfo();	//Login
		logger.log(LogStatus.PASS, "Login successfully with sales specialist ");
