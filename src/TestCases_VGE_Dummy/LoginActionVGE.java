...
public class LoginActionVGE extends CommonMethod
{
	String uniqueID;
	String userName;
	String password;
	...
	public void FillLoginInfoVGE() throws IOException 
	{
		getData();
	...
	{
		ArrayList<String> list=ReadExcelFile.readExcelFileInfo("D:\\Workspace\\CPQ\\src\\TestData\\CPQ_Test_DataVGE.xlsx","SITCredentials",uniqueID);
	...
	public void clickAccountChk() throws IOException
	{
		selectCheckbox(ReadConfigES.GetValES("addAccountTeamMember_chk_Xp"));
	}
