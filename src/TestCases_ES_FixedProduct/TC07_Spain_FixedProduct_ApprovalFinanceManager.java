...
public class TC07_Spain_FixedProduct_ApprovalFinanceManager {
	...
	public void beforeSuite()
	{
		...
		logger=reports.startTest("TC20_Spain_FixedProduct_ApprovalFinanceManager");
	}
	...
	@Test
	public void ApprovalFinanceManager() throws IOException, InterruptedException, AWTException
	{
		
		lae.setUniqueID("Finance_Manager");
		lae.FillLoginInfoES();	//Login
		logger.log(LogStatus.PASS, "Login successfully with Spain Commercial_Manager");
		fm.readFinanceManagerSRNESFromConfig();
		logger.log(LogStatus.PASS,"Read SRN from Configfile");
		fm.setSearchFinanceSRNtxt(fm.getFinanceSRNumberRecent());
		fm.searchFinanceSRNES();
		fm.enableFinanceCPQApprovalES();
