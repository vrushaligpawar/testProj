...
public class TC12_Spain_CloneQuote {
	...
	public void beforeSuite()
	{
		...
		logger=reports.startTest("TC12_Spain_CloneQuote");
	}
	...
	public void generateContract() throws IOException, InterruptedException
	{
		...
		if(gipe.verifyCloneQuote())
		{
			logger.log(LogStatus.PASS, "Quote Clone Sucessfully");
		}else
		{
			logger.log(LogStatus.FAIL, "Quote not Clone");
		}
	}
