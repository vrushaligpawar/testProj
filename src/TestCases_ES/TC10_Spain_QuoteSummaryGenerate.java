...
public class TC10_Spain_QuoteSummaryGenerate {
	...
	public void beforeSuite()
	{
		...
		logger=reports.startTest("TC10_Spain_QuoteSummaryGenerate");
	}
	...
	public void generateContract() throws IOException, InterruptedException
	{
		...
		gipe.clickQuoteSummaryGenerate();
		logger.log(LogStatus.PASS, "Quote Summary Generate Sucessfully");
