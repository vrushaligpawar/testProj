...
public class TC08_Spain_ContractGenerate {
	...
	public void beforeSuite()
	{
		...
		logger=reports.startTest("TC08_Spain_ContractGenerate");
	}
	...
	public void generateContract() throws IOException, InterruptedException
	{
		...
		if(gipe.clickContractTab())
		{
			logger.log(LogStatus.PASS, "Contract Tab Click successfully");
		}else
		{
			logger.log(LogStatus.FAIL, "Contract Tab not click");
		}
		gipe.selectExpectedSignDate();
		logger.log(LogStatus.PASS, "Expected sign Date entered successfully");
		gipe.clickGenerateContract();
	}
